...
| `nginxConfiguration`                   | The content for your custom httpd.conf file (advanced feature)                        | `""`               |
| `existingNginxConfigurationConfigMap`  | The name of an existing secret with your custom httpd.conf file (advanced feature)    | `""`               |
